...
//
//            com.elasticplayground.client.User city1 = new com.elasticplayground.client.User(i, "郭德纲"+i, dlat, dlon);
...
//
//
//    public static String obj2JsonUserData(com.elasticplayground.client.User user) {
